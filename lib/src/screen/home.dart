...
import 'package:money_transfer_flutter_app/src/models/hex_color.dart';
import 'package:money_transfer_flutter_app/src/widget/cards.dart';
import '../common.dart';
            ...
            child: new Wrap(
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Text("Barack Obama", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold ),),
                ),
                Container(
                  alignment: Alignment.center,
